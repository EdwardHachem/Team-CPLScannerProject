...
enum class TokenType {
	...
	LESSTHANOREQUALTO, NOTEQUAL, EQUAL, GREATERTHAN, GREATERTHANOREQUALTO, SQR, EXP, POWER, STRINGIDENTIFIER,
	GOTO, PRINT, DEF, FOR, LET, NEXT, INT, RND, LEFTPAREN, RIGHTPAREN, RETURN, STOP, GOSUB, INPUT, READ, NEGATE,
	STRINGLITERAL, NUMBERDBLLITERAL, NUMBERINTLITERAL, IDENTIFIER, PROGRAMLINENUMBER, EOL, TO, COMMA
};
class BasicToken
{
public:
