...
enum class TokenType {
	...
	LESSTHANOREQUALTO, NOTEQUAL, EQUAL, GREATERTHAN, GREATERTHANOREQUALTO,
	GOTO, PRINT, DEF, FOR, LET, NEXT, INT, RND, LEFTPAREN, RIGHTPAREN, RETURN, STOP, GOSUB, INPUT, READ,
	STRINGLITERAL, NUMBERDBLLITERAL, NUMBERINTLITERAL, IDENTIFIER, PROGRAMLINENUMBER, EOL
};
class BasicToken
{
public:
